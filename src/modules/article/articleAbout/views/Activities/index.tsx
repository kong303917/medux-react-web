...
const Component: React.FC = () => {
  return (
    <section className={`${styles.root} g-doc`} id="articleHome_Activities">
      ...
      <article>
        <p>
          一年前，我们将「自然」确立为 Ant Design 的核心价值观，来指导我们的设计工作。一年来，越来越多的产品通过使用 Ant Design 为成千上万用户提供优质的企业级服务；同时，也有越来越多的设计体系基于 Ant
          Design 蓬勃生长。这一次，我们将清晰阐述「自然」这一价值观，希望能启发或帮助大家完成自己的产品 / 体系构建；同时，你们的反馈和互动也会成为我们进步的源泉和动力。
        </p>
